...
- CFG autor:
  ...
  - Thanks to [@Lendersmark](https://github.com/Lendersmark) and (fork [ckau-book-enhanced](https://github.com/Lendersmark/ckau-book-enhanced)) for helping with the project
- Based on:
